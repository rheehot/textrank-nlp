...
if __name__ == '__main__':
    ...
    word_matrix, vocab = tokenizer.get_word_corr_matrix(doc)
    ranking = get_page_rank(word_matrix, vocab)
    extractor = Extractor(ranking)
    visualize_graph(word_matrix)
    print(extractor.extract_top_k(3))

    #   [('오후', 0.02603811603003733), ('총기', 0.02354710580600038), ('경찰', 0.023228026293423073)]
    #   [('오후', 0.02578311098837809), ('총기', 0.023914920003056166), ('발사', 0.02390479256478881)]
